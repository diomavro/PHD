...
% In the standard literature, the only source of revenue for a firm is to sell the product. However there are situations, especially in the digital world where having a larger user base also allows for additional indirect profit opportunities. For instance in a social network, a larger user base allows the network owner to sell advertising slots at a higher price, and the wider the reach the more profitable the enterprise. This extra source of revenue is parameterized with the letter $\lambda$. It should be noted that increasing pirates or buyers increase revenue from this source. 
...
\begin{align*}
\tilde{\pi} &< \pi  \\
% \frac{4}{27} \left( \alpha + 1+k \right) &< \frac{1}{4} \left( \alpha - \beta + k \right) \\
% \frac{16}{27} \left( \alpha + 1+k \right) &< \left( \alpha - \beta + k \right) \\
% \frac{16}{27}  + \beta &< \frac{11}{27}( \alpha + k) \\
% 16 + 27 \beta &< 11( \alpha + k) \\ 
