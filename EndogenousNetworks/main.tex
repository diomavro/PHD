...
\begin{definition}
Consider some technological network $\text{g}=(s_1,\ldots, s_n)$ and assume that there is a subgraph $\text{g}'$ on $m\leq n$ firms that is a chain with $s_i=i-1$ for all $1\leq i \leq m$ for some $2\leq m\leq n$. The subgraph $\text{g}'$ will be referred to as the chain of $m$ incumbents of \text{g}.
\end{definition}
