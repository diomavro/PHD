...
\frabstract{
Nous considérons des situations dans lesquelles les agents peuvent choisir entre des projets. Nous montrons comment les hypothèses de structure de marché spécifiques influent sur le type de résultats recherchés. Nous montrons d’abord les conditions dans lesquelles les entreprises choisiront des agents piratant leurs produits. Nous montrons également que permettre aux entreprises de racheter d’autres entreprises peut pousser l’innovation à des projets plus sûrs. Enfin, nous montrons que les agents qui choisissent parmi les paiements effectueront une remise en fonction de l’environnement qui les entoure.
}

\enabstract{
We consider situations where agents can choose between projects. We show how specific market structure assumptions influence what kind of outcomes are pursued. First we show conditions under which firms will opt into agents pirating their product. We also show that enabling firms to buyout other firms can push innovation towards safer projects. Finally we show that agents choosing among payments will discount as a function of the environment around them. 
}
