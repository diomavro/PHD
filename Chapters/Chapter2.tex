...
% \begin{align*}
% \pi_{i}(c_{i2},c_{e})-  \pi_i(c_i,c_{e})\leq \pi_{e}(c_{i},c_{e2})  \left( t_2- \frac{1}{q} \left( 1-(1-q)^{T} \right) \right) +
...
% A \geq B \\ 
% \Rightarrow 
% \pi_{e}(c_{i},c_{e2})  \left( t_2-1- \frac{1}{q} \left( 1-(1-q)^{T} \right) \right) +2(\pi_i(c_i,c_{e1})+\pi_e(c_i,c_{e1})) \geq 0 \\
% \end{align*}
...
% A \geq B \\ 
% \Rightarrow 
% \pi_{e}(c_{i},c_{e2})  \left( t_2-1- \rho \right) +2(\pi_i(c_i,c_{e1})+\pi_e(c_i,c_{e1})) \geq 0 \\
% \end{align*}
% Recall by assumption \ref{rho} that $\rho < t_2$ so our term 
