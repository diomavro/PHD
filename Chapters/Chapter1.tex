...
12\alpha+(k+1)(13-3 \alpha)
\right) < \frac{12}{71 } \\
\text{Recall that the slope of the profit function with pirates is $\frac{1}{4}$} \\
\rightarrow \text{Profit under piracy increases more than profit without piracy}  \\
\text{ if $\alpha$ is relatively large}
\end{align*}
