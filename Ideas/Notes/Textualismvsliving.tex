...
What does an individual need to make plans? An individual need to have the legal uncertainty minimized. A decision that cannot be predicted, from the point of view of the individual, is arbitrary. 

know what other people PLAN to do if they do s

A ruling that cannot be predicted is arbitrary. 
