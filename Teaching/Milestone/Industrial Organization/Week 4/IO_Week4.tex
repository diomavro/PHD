...
\title[\begin{flushleft} \color{white} {\tiny ???} \end{flushleft}]{\bf {Industrial Organization, Week 4 \\ 
Dynamic Oligopoly}}
...
\bi
\item Plan: We look at our second dynamic model today
\item Economic modelling works by gradually making things more complicated
\ei

}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\ft{Sequential equilibrium}
\setbeamertemplate{itemize items}[triangle]

\bi
\item In game theory there is a whole family of equilibrium concepts we can use when there is time
\item Examples: Risk, Markovian, Perfect, subgame perfect, bayesian, sunspot, etc
\item Refinements: The most famous is called cho kreps intuitive criterion
\item Most are discrete concepts
\item In infinite games there are more equilibria possible which enable cooperation
\ei
...
\section{Stackelberg}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\ft{Stackelberg}

\setbeamertemplate{itemize items}[triangle]

\begin{picture}(80,80)(0,0) %syntax: \begin{picture}(width,height)(x-offset,y-offset)
\put(240,-20){\includegraphics[width=5cm]{./IO_Week4_Stackelberg.jpg}}
\end{picture}

\bi
\item Born in 1905 Russia, died at 40 in Spain
\item What happens if one firm produces first?
\item Incumbent and Entrant take decisions at different times
\ei
...
\begin{picture}(80,80)(0,0) %syntax: \begin{picture}(width,height)(x-offset,y-offset)
\put(80,-150){\includegraphics[width=10cm]{./IO_Week4_Commitment.jpg}}
\end{picture}

}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\ft{Timing and Strategy}
\setbeamertemplate{itemize items}[triangle]

\bi
\item t=0 Firm 1 produces first
\item t=1 Firm 2 produces second
\item t=2 Profits are realized
\item Backward induction implies, start with second mover
\item Then plug in second movers move into first movers
\item Once we have both we can plug them into profits/price
\ei

}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\ft{Sequential equilibrium 1}
\setbeamertemplate{itemize items}[triangle]
...
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\text{The profit function is} ~~ 
&& \pi_2(q_1,q_2) = P(Q)q_2-cq_2 
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\text{FOC} ~~ 
&& \frac{\delta \pi_2 }{\delta q_2} =  600-q_1-2q_2-c = 0
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\text{Re-arrange} ~~
&& q_2 =  \frac{600 - c - q_1}{2}
\end{align*}

}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\ft{Sequential equilibrium 2}
\setbeamertemplate{itemize items}[triangle]

\begin{align*}
&\text{Now we setup the profit of firm 1} ~~ 
&& \pi_1(q_1,q_2) = (600-q_1-q_2)q_1-q_1c
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\text{Plug-in the reaction of firm 2} ~~ 
&& \pi_1(q_1,q_2) = (600-q_1-\frac{600 - c - q_1}{2})q_1-q_1c
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\text{Simplify} ~~ 
&& = (300 +\frac{c}{2} - \frac{ q_1}{2})q_1-cq_1
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\text{Take the derivative} ~~ 
&& \frac{\delta \pi_1 }{\delta q_1} = 300 + \frac{c}{2} - q_1 -c = 0
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\text{Solve for the quantity} ~~ 
&& q_1 = 300 - \frac{c}{2}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{align*}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\ft{Sequential equilibrium 3}
\setbeamertemplate{itemize items}[triangle]

\begin{align*}
&\text{We have our two q's} ~~ 
&& q_1 = 300 - \frac{c}{2}; q_2 =  \frac{600 - c - q_1}{2}
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
&\text{Plug-in the reaction of firm 2} ~~ 
&& q_2 =  150 - \frac{c}{4} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\ft{How to plot isoprofit}
\setbeamertemplate{itemize items}[triangle]

\bi
\item To plot the isoprofit on the reaction curve graph do the following: 
\item pick a number, say h
\item equalize $\pi_1(q_1,q_2)=h$
\item solve for $q_2$
\item Do this a few times with different h
\item Plot each $q_2$
\item note: if the curves intersect you have a mistake
\ei
