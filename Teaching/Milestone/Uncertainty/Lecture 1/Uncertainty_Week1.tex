...
\title[\begin{flushleft} \color{white} {\tiny ???} \end{flushleft}]{\bf {Uncertainty Week 1, Week 1 \\ 
Classical probability and decision outcome based decisions}}
...
\setbeamertemplate{itemize items}[triangle]
\bi
\item \textbf{Uncertainty:} Incomplete knowlede about the probabilities of events.
\item \textbf{Why do we care?:} Incomplete knowlede about the probabilities of events.
\bi
\item first 1
\item second 2
\ei
