...
%The debate first and then the work
%mentor? 
...
%a price control or power limitation, clarify transfer sentence
...
%changes, why fences, why an oasis
...
%tragedy of the commons explain
...
%Innovation in small firms explain more, explain more about the owner
...
%removed 2 words, described and where
...
%definition, by lawyers and economists
...
%similar for both or something like that 
%basic calculus
...
%inneffective otherwise. fullstop
%Sufficient profits in a fixed time period
...
%maybe think about this more because repeats
...
%institutional, fullstop, think about adding the work on bureactacy
